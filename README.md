...
![Build and Scan](https://github.com/Minouspi/devops-tp-docker-gilbert/actions/workflows/docker-deploy.yml/badge.svg)
![CodeQL](https://github.com/Minouspi/devops-tp-docker-gilbert/actions/workflows/codeql-analysis.yml/badge.svg)
...
```bash
docker pull ghcr.io/minouspi/devops-tp-docker-gilbert:main
docker run -p 8080:8080 ghcr.io/minouspi/devops-tp-docker-gilbert:main
trivy image ghcr.io/minouspi/devops-tp-docker-gilbert:main
